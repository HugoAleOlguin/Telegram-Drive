    ...
    return (
      <div className={styles.listRow}
        ...
        <div className={styles.listActions}>
          <button className={styles.listAction} onClick={e => { e.stopPropagation(); onRename(file); }} aria-label="Rename">
            <IconRename />
          </button>
          <button className={styles.listAction} onClick={e => { e.stopPropagation(); onDownload(file); }} aria-label="Download">
            <IconDownload />
          </button>
          <button className={styles.listActionDanger} onClick={e => { e.stopPropagation(); onDelete(file.id); }} aria-label="Delete">
            <IconDelete />
          </button>
        </div>
      </div>
  ...
  return (
    <div className={styles.gridCard}
      ...
      <div className={styles.fileActions}>
        <button className={styles.fileAction} onClick={e => { e.stopPropagation(); onRename(file); }} aria-label="Rename">
          <IconRename />
        </button>
        <button className={styles.fileAction} onClick={e => { e.stopPropagation(); onDownload(file); }} aria-label="Download">
          <IconDownload />
        </button>
        <button className={styles.fileActionDanger} onClick={e => { e.stopPropagation(); onDelete(file.id); }} aria-label="Delete">
          <IconDelete />
        </button>
      </div>
    </div>
